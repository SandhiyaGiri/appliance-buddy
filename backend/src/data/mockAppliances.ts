...
export const generateMockAppliances = (now = new Date()): Appliance[] => {
  ...
  appliances.push({
    ...
    created_at: subMonths(now, 23).toISOString(),
    updated_at: subMonths(now, 23).toISOString(),
    supportContacts: [
      {
        id: crypto.randomUUID(),
  ...
  appliances.push({
    ...
    created_at: subYears(now, 3).toISOString(),
    updated_at: subYears(now, 3).toISOString(),
    supportContacts: [
      {
        id: crypto.randomUUID(),
  ...
  appliances.push({
    ...
    updated_at: subMonths(now, 8).toISOString(),
    supportContacts: [
      {
        id: crypto.randomUUID(),
